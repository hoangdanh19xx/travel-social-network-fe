...
function ChatInput() {
  return (
    <div className="w-[800px] flex items-center bg-[#DCD7C9] p-2 rounded">
      <div className="w-full flex items-center gap-1">
        ...
        <input
          type="text"
          className="flex-1 p-2 w-full bg-transparent placeholder:text-[gray]"
          placeholder="Your message..."
        />
      </div>
      <div className="px-2 flex gap-4 cursor-pointer">
        <i className="text-[gray] fa-solid fa-microphone"></i>
        <i className="text-[gray] fa-solid fa-paperclip"></i>
